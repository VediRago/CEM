...
**Depends on:** [`420_The_Four_Levels_of_Evidence.md`](../400_Model/420_The_Four_Levels_of_Evidence.md), [`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md)
...
Confidence has appeared, undefined, in four separate chapters: [`130_The_Problem.md`](../100_Foundations/130_The_Problem.md) (implicitly, in the reliability of a single observation), [`420_The_Four_Levels_of_Evidence.md`](../400_Model/420_The_Four_Levels_of_Evidence.md) (implicitly, in the distinction between what can and cannot be stated as fact), [`430_The_Investigator.md`](../400_Model/430_The_Investigator.md) (as an assumption not yet tested), and [`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md) (explicitly, as a per-finding property with an unresolved scale). This recurrence across four chapters, none of which formally defined the concept, is itself the evidence that Confidence needed its own chapter — consistent with this repository's own discipline of building structure only once real pressure for it exists, not speculatively.
...
[`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md)'s open question — what is the actual relationship between source count and confidence for a Pattern — can be partially answered here, though not fully resolved. A Pattern built from the minimum number of sources required to count as a pattern at all (per [`420_The_Four_Levels_of_Evidence.md`](../400_Model/420_The_Four_Levels_of_Evidence.md), more than one) should carry lower confidence than the same pattern supported by many independent sources. But "how much lower" cannot be reduced to a fixed formula without testing against real cases — the relationship is directional, not yet quantified.
...
- **Observation-level confidence** represents verification status: directly confirmed, reported but unconfirmed, or unable to verify (per the Verification gap already flagged in [`430_The_Investigator.md`](../400_Model/430_The_Investigator.md)).
...
- This chapter explicitly avoids quantifying the source-count-to-confidence relationship, which leaves [`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md)'s original open question only partially resolved — directionally answered, not operationally answered. A future evaluator building a real implementation will still need to make that quantification decision without guidance from this chapter.
- This chapter does not address confidence for Level 3 interpretations at all, even though [`420_The_Four_Levels_of_Evidence.md`](../400_Model/420_The_Four_Levels_of_Evidence.md) permits interpretations to be offered when marked. If interpretations can vary in how well-supported they are, this chapter's framework may need extending to cover that case too.

---

# 10. Open Questions

- What is the actual quantitative relationship between source count and Pattern-level confidence? (Deferred, not resolved, from [`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md).)
...
[`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md)

---

# 12. Used By

[`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md) should be revisited once this chapter is stable, to confirm its existing Confidence field matches this chapter's two-tier definition rather than the less specific placeholder treatment it currently has.
...
- v0.1 — Initial draft. Built in response to Confidence's undefined recurrence across four chapters (130, 420, 430, 480), directly addressing the deferred scale/threshold question from [`480_The_Investigation_Dossier.md`](../400_Model/480_The_Investigation_Dossier.md)'s Open Questions. Established a two-tier definition (Observation-level = verification status, Pattern-level = strength of inference from repetition) rather than a single universal scale, and left the actual quantitative relationship between source count and confidence as an open question rather than speculating on a formula without evidence.
