# 410. The Four Levels of Evidence
...
During the development of this repository, CEM's own process produced a conclusion about the person building it: a statement that they "repeatedly develop frameworks that preserve complex information while making it easier for others to understand, investigate, navigate, and build upon."

That statement was generated by pattern recognition across five independent bodies of work, without an explicit, separate human-interpretation step. It surfaced a real tension: does CEM's own development process already violate the rule this chapter exists to establish?
