...
Migration of `110_What_is_CEM.md` exposed two ambiguities in Blueprint v1.1:
...
Draft. To be validated against the Foundation chapters before replacing Blueprint v1.1 as the frozen standard.
